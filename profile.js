...
function renderProjects(projects) {
  ...
  projectsList.innerHTML = projects.map(project => {
    ...
    return `<article class="project-card">
      ...
      ${finalUrl ? `<div class="final-video-panel"><div><small>Your Final Video</small><a href="${finalUrl}" target="_blank" rel="noopener">Watch / download your video ↗</a></div></div>` : ''}
